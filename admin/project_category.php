...
<div class="bodybox">
    ...
    <div class="mainContent" id="mainContent">
        <!-- tags js在 main.js -->
        <div class="tags">
            <a class="tag A focus">Project Category</a>
        ...
        <div class="block A focus">
            ...
            <div class="box-content">
                <div class="box-content"  v-if="!isEditing">
                    <ul>
                        <li><b>Project Category</b></li>
                        <li style="padding-bottom:10px;"><input type="text" v-model="category" required onfocus="this.placeholder = ''"  maxlength="255" onblur="this.placeholder = ''" style="width:100%" ></li>
                ...
                <div class="box-content" v-else>
                    <ul>
                        ...
                        <li style="padding-bottom:10px;"><input type="text" v-model="record.category" required onfocus="this.placeholder = ''"  maxlength="255" onblur="this.placeholder = ''" style="width: 100%"></li>
                ...
                <div class="tablebox">
                    ...
                    <li><i class="micons">view_list</i></li>
                        <li style="font-size:10px;">Project Category</li>
                    ...
                    <ul v-for='(record, index) in displayedPosts' :key="index">
                        ...
                        <li style="font-size:10px;">{{record.category}}</li>
...
<script defer src="../js/admin/project_category.js"></script>
</html>
