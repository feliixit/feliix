...
if($user_id == 48 || $user_id == 2 || $user_id == 1 || $user_id == 6 || $user_id == 3 || $user_id == 89 || $user_id == 148)
$test_manager = "1";
}
            ...
            <div class="tableframe">
                <div class="tablebox lv1">
                    ...
                    <ul v-for='(receive_record, index) in displayedPosts'>
                        <li>
                            <a v-show="receive_record.is_edited == 1" v-bind:href="'quotation_pageless?id=' + receive_record.id">{{
...
<script defer src="js/quotation_pageless_mgt.js"></script>
