...
<style>
    ...
    .meetingform-item input, .meetingform-item select, .meetingform-item textarea{
        border: 1px solid #707070;
        font-size: 14px;
        outline: none;
    }
    .meetingform-item input:disabled, .meetingform-item select:disabled, .meetingform-item textarea:disabled{
        border: 1px solid #707070;
        font-size: 14px;
        outline: none;
        opacity: 1;
...
<div id="meeting">
    ...
    <form id="addmeeting-form" style="display: none;">
        <fieldset>
            ...
            <div class="meetingform-item">
                ...
                <select style="flex-grow: 1" id="newAttendee"></select>
            </div>
    ...
    <form id="editmeeting-form" style="display: none;">
        <fieldset disabled>
            ...
            <div class="meetingform-item">
                <label>Attendee:</label>
                <select style="flex-grow: 1" id="oldAttendee"></select>
            </div>
