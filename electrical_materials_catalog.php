...
<head>
    ...
    <!-- SEO -->
    <title>Electrical Materials Catalog</title>
...
<div class="bodybox">
    ...
    <div class="mainContent" id="app">
        ...
        <!-- 新增和修改 Tag 的 Group -->
        <div class="region">
            <span class="heading">Add/Edit Electrical Material Item</span>

            <div class="heading-and-btn" :ref="'porto'">
                <ul>
                    <li>
                        <input type="text" class="form-control" v-model="particulars" placeholder="Particulars">
...
<script defer src="js/electrical_materials_catalog.js"></script>
