...
<head>
    ...
    <style>
        ...
        .block.A .tb_order thead tr th:nth-of-type(1), .block.A .tb_order tbody tr td:nth-of-type(1) {
            min-width: 90px;
            text-align: center;
        }
        ...
        .block.A .tb_order thead tr th:nth-of-type(4) {
            min-width: 930px;
        }

        .block.A .tb_order tbody tr td:nth-of-type(4) {
            width: 530px;
        }
        ...
        .block.A .tb_order thead tr th:nth-of-type(5), .block.A .tb_order tbody tr td:nth-of-type(6) {
            min-width: 130px;
        }
...
<div class="bodybox" id="app">
    ...
    <div class="mainContent">
        ...
        <div class="list_function main" style="border: none; margin-bottom: -15px; padding-left: 15px;">
        ...
        <div class="block A" style="display: block;">
                ...
                <div class="list_function main">
                    ...
                    <div class="block">
                        ...
                        <div class="popupblock">
                            <a title="Add Item by Manual Encoding" v-if="(status == 0 && is_ariel == false) || (status == 1 && is_ariel == true)">
                                <i class="fas fa-plus" @click="addItem()"></i>
                            </a>
                        </div>

                        <div class="popupblock">
                            <a title="Add Item from Product Database" v-if="(status == 0 && is_ariel == false) || (status == 1 && is_ariel == true)">
                                <i class="fas fa-list-alt"  @click="product_catalog()"></i>
                            </a>
                        </div>

                        <div class="popupblock">
                            <a title="Add Item from Existing Quotation" v-if="(status == 0 && is_ariel == false) || (status == 1 && is_ariel == true)">
                        ...
                        <td>
                            ...
                            <div class="write_block" v-if="item.is_edit">
                                <select v-model="item.confirm">
                                    <option value=""></option>
                                    <option value="N">Price Inquiry</option>
                                    <option value="C">Stock Inquiry</option>
                                    <option value="D">Product Inquiry</option>
                                </select>
                            </div>
                        </td>
            ...
            <td>
                ...
                <div class="write_msg_block" v-if="show_notes()">
            ...
            <td>
                <div class="btnbox">
                    <i class="fas fa-arrow-alt-circle-up" @click="page_up(index, item.id)" v-if="show_page_up(item)"></i>
                    <i class="fas fa-arrow-alt-circle-down" @click="page_down(index, item.id)" v-if="show_page_down(item)"></i>
                    <i class="fas fa-edit" @click="editItem(item)" v-if="show_edit(item)"></i>
                    <i class="fas fa-trash" @click="item_delete(item)" v-if="show_delete(item)"></i>
                    <i class="fas fa-camera" @click="print_me(item)" v-if="show_print(item)"></i>
                ...
                <div class="list_function" style="margin: 7px 0;">
                    ...
                    <div>
                        <table id="tb_product_list" class="table  table-sm table-bordered">
                            ...
                            <td>
                                    <span v-show="((cost_lighting == true && item.category == 'Lighting') || (cost_furniture == true && item.category == 'Systems Furniture')) === true">CP: {{ item.price_ntd }} <br v-if="item.str_price_ntd_change"> {{ item.str_price_ntd_change ?  item.str_price_ntd_change : '' }}<br></span>
...
<script defer src="js/inquiry_taiwan.js"></script>
