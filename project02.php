                                    ...
                                    <div class="Info_A">
                                        ...
                                        <dd>
                                            <div class="browser_group">
                                                <select v-model="uid">
                                                    <option v-for="(item, index) in users_del" :value="item.id" :key="item.username">
                                                        {{ item.username }}
                                                    </option>
                                                </select>
                                ...
                                <dl>
                                    ...
                                    <dd style="display: flex; justify-content: flex_start;">
                                        ...
                                        <div class="pub-con" ref="bg">
                                            <div class="input-zone">
                                                ...
                                                <input class="input" type="file" name="comm_file" value placeholder="choose file" ref="comm_file" v-show="comm_canSub" @change="comm_changeFile()" multiple />
                                            </div>
                                        </div>
                                    </dd>
                                    ...
                                    <div class="file-list">
                                        <div class="file-item" v-for="(item,index) in comm_fileArray" :key="index">
                                            <p>
                                                {{item.name}}
                                                <span @click="comm_deleteFile(index)" v-show="item.progress==0" class="upload-delete"><i class="fas fa-backspace"></i>
                                                </span>
                                            </p>
                                ...
                                <dl>
                                    ...
                                    <dd style="display: flex; justify-content: flex_start;">
                                        ...
                                        <div class="pub-con" ref="bg">
                                            <div class="input-zone">
                                                <span class="upload-des">choose file</span>
                                                <input class="input" type="file" name="approve_file" value placeholder="choose file" ref="approve_file" v-show="approve_canSub" @change="approve_changeFile()" multiple />
                                            </div>
                                        </div>
                                    </dd>
                                    ...
                                    <div class="file-list">
                                        <div class="file-item" v-for="(item,index) in approve_fileArray" :key="index">
                                            <p>
                                                {{item.name}}
                                                <span @click="approve_deleteFile(index)" v-show="item.progress==0" class="upload-delete"><i class="fas fa-backspace"></i>
                                                </span>
                                            </p>
                                            <div class="progress-container" v-show="item.progress!=0">
                                                <div class="progress-wrapper">
            ...
            <div class="block left">
                ...
                <div class="Info_A">
                    ...
                    <div class="tablebox lv2a">
                        ...
                        <ul>
                            <li class="morespace">
                                <div v-for='(receive_record, index) in project_approves'>• {{ receive_record.comment }} <br v-if="receive_record.items.length > 0">
                                    <span v-for="item in receive_record.items">
                                        <a :href="baseURL + item.bucket + '\\' + item.gcp_name" target="_blank" class="attch">{{item.filename}}</a>
                                    </span>
                                    <br>({{ receive_record.username }} at {{ receive_record.created_at }})
