...
<div id="app" class="bodybox">
    ...
    <div class="mainContent">
        ...
        <div>
        <template v-for="(item, index) in receive_records">
            <table id="tb_product_list" :class="['table', 'table-sm', 'table-bordered', 'tb_product_list_' + item.id]" >
...
<script defer src="js/product_calatog_pic_export.js"></script>
