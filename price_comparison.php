                            ...
                            <table class="tb_format1">
                                ...
                                <template v-for="(group, group_index) in dis_groups">
                                    ...
                                    <tr class="tfoot4">
                                        ...
                                        <td v-if="total_disp.total1 == '' || total_disp.total1 == (((subtotal_a * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100) !== undefined ? ((subtotal_a * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100).toFixed(2) : 0)"><span class="numbers">₱ {{ ((subtotal_a * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100) !== undefined ? ((subtotal_a * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100).toFixed(2).toLocaleString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "0.00" }}</span></td>
                                        <td v-if="total_disp.total1 != '' &&  total_disp.total1 != (((subtotal_a * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100) !== undefined ? ((subtotal_a * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100).toFixed(2) : 0)"><span class="numbers deleted">₱ {{ ((subtotal_a * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100) !== undefined ? ((subtotal_a * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100).toFixed(2).toLocaleString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "0.00" }}</span><br><span class="numbers">₱ {{ Number(total_disp.total1).toFixed(2).toLocaleString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}</span></td>

                                        <!-- 第二個option -->
                                        <td colspan="2">Alternative Grand Total</td> <!---->
                                        <td  v-if="total_disp.total2 == '' || total_disp.total2 == (((subtotal_b * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100) !== undefined ? ((subtotal_b * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100).toFixed(2) : 0)"><span class="numbers">₱ {{ ((subtotal_b * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100) !== undefined ? ((subtotal_b * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100).toFixed(2).toLocaleString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "0.00" }}</span></td>
                                        <td v-if="total_disp.total2 != '' && total_disp.total2 != (((subtotal_b * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100) !== undefined ? ((subtotal_b * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100).toFixed(2) : 0)"><span class="numbers deleted">₱ {{ ((subtotal_b * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100) !== undefined ? ((subtotal_b * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100).toFixed(2).toLocaleString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "0.00" }}</span><br><span class="numbers">₱ {{ Number(total_disp.total2).toFixed(2).toLocaleString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  }}</span></td>

                                        <!-- 第三個option -->
                                        <td colspan="2"  v-if="temp_options.length == 3">Alternative 2 Grand Total</td> <!---->
                                        <td  v-if="temp_options.length == 3 && (total_disp.total3 == '' || total_disp.total3 == (((subtotal_c * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100) !== undefined ? ((subtotal_c * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100).toFixed(2) : 0))"><span class="numbers">₱ {{ ((subtotal_c * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100) !== undefined ? ((subtotal_c * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100).toFixed(2).toLocaleString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "0.00" }}</span></td>
                                        <td v-if="temp_options.length == 3 && (total_disp.total3 != ''  && total_disp.total3 != (((subtotal_c * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100) !== undefined ? ((subtotal_c * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100).toFixed(2) : 0)))"><span class="numbers deleted">₱ {{ ((subtotal_c * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100) !== undefined ? ((subtotal_c * (100 - total_disp.discount) / 100) * (total_disp.vat == '' ? 100 : 112) / 100).toFixed(2).toLocaleString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "0.00" }}</span><br><span class="numbers">₱ {{ Number(total_disp.total3).toFixed(2).toLocaleString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  }}</span></td>
                                    </tr>
