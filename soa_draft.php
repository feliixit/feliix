                    ...
                    <div class="qn_header" v-if="show_title">
                        ...
                        <div class="left_block">
                            ...
                            <div class="soa_bill_title">
                                Bill to:<br>
                                <span class="soa_bill_1stline">{{}}</span><br>
                                <span class="soa_bill_2ndline">{{}}</span><br>
                                <span class="soa_bill_3rdline">{{}}</span>
                            </div>

                            <div class="soa_remarks">{{}}</div>
                        ...
                        <div class="right_block">
                            ...
                            <div class="soa_info">
                                ...
                                <ul class="soa_info_2ndline">
                                    <li>Quotation Number / P.O. Number:</li>
                                    <li>{{}}</li>
                                </ul>
                ...
                <td style="vertical-align: top;">
                    ...
                    <div class="qn_body">
                        ...
                        <div class="area_conforme" v-bind:style="{ 'margin-top': (show_s == '' ? pixa_s : 0) + 'px' }" v-if="show_s == ''">
                            ...
                            <div class="company_signature"
                                 v-if="(sig != undefined ? pag.sig.item_company.length : 0) > 4">
