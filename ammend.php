        ...
        <div class="block D">
            ...
            <div class="box-content">
                ...
                <div class="tablebox" v-if="view_void_detail">
                    <ul class="head">
                        <li class="head">Leave Type</li>
                        <li>{{ (void_record.leave_type == 'A' || record.leave_type == 'N') ? "Service Incentive Leave" : ((void_record.leave_type == 'B' || record.leave_type == 'S') ? "Sick Leave" : ((void_record.leave_type == 'C' || record.leave_type == 'U') ? "Unpaid Leave" : 'Absence')) }}</li>
                    </ul>
                    <ul>
                        <li class="head">Application Time</li>
