                        ...
                        <table id="tb_product_list" class="table  table-sm table-bordered">
                            ...
                            <template v-for="(item, index) in displayedPosts">
                                ...
                                <tr class="set_format2" v-for="(set, index) in item.product_set">
                                    ...
                                    <td>
                                        <span v-show="((cost_lighting == true && set.category == 'Lighting') || (cost_furniture == true && set.category == 'Systems Furniture')) == true && toggle == true">CP: {{ set.price_ntd }} <br v-if="set.str_price_ntd_change"> {{ set.str_price_ntd_change ?  set.str_price_ntd_change : '' }} <br></span>
