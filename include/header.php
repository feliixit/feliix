...
try {
        ...
        if($username == "Kristel Tan" || $username == "Kuan" || $username == "Dennis Lin" || $username == "Marie Kayla Patricia Dequina" || $username == "Gina Donato" || $username == "Jack Beringuela" || $username == "Johmar Maximo" || $username == "Stephanie De dios")
        {
            $dashboard = true;
        }
