            ...
            <div class="modal-body">
                ...
                <div class="form-inline row">
                    ...
                    <div class="col-10">
                        ...
                        <input type="time" class="form-control" style="width:40%; padding-right: 0; text-align: center;" id="???" disabled>
                ...
                <div class="button_box">
                    ...
                    <button class="btn btn-primary" id="btn_???">Send Request</button>

                    <button class="btn btn-secondary" id="btn_???">Withdraw Request</button>
