...
<div class="bodybox">
    ...
    <div id="app" class="mainContent">
        ...
        <div class="block A focus" style="position: relative;">
            <h6>Office Item Inventory Replenishment<span>{{ record.request_no }} {{ record.check_name }}</span></h6>

            <div class="box-content" id="phase1" v-if="record.status == 1">

                <div class="headings">
                    <b class="tag focus">PHASE 1</b>
                    <b class="tag">Checker Creates Item List and Encodes Replenished Qty</b>
                </div>
            ...
            <div class="box-content" id="phase2" v-if="record.status == 2">
                ...
                <div class="tablebox notes">
                    <ul class="head">
                        <li>PHASE 1: Checker Creates Item List and Encodes Replenished Qty<br>Notes</li>
                        <li>{{ notes }}</li>
                    </ul>
                    <ul class="head">
            ...
            <div class="box-content" id="phase3" v-if="record.status == 3">
                ...
                <div class="headings">
                    ...
                    <b class="tag">Inventory Replenishment Completed</b>
                </div>
...
<script src="js/office_item_inventory_replenish.js"></script>
