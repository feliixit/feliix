...
try {
    ...
    {
        if(trim(strtoupper($position)) == 'SALES MANAGER' || trim(strtoupper($position)) == 'ASSISTANT SALES MANAGER')
        {
            $access6 = true;
        }
    }
...
<script type="text/javascript" src="js/task_management_sls.js" defer></script>
