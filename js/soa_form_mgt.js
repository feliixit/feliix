  ...
  */
  ...
  methods:{
    ...
    getCreators () {
      ...
      axios
          .get('api/admin/soa_form_quotation_creators', { headers: {"Authorization" : `Bearer ${token}`} })
          .then(
          (res) => {
      ...
      Swal.fire({
          ...
          if (result.value) {
            ...
            let me = _this;
              ...
              //DELETE table_name WHERE ID=id;
              $.ajax({
                  url: "api/soa_form_quotation_delete",
                  type: "POST",
                  contentType: 'multipart/form-data',
                  processData: false,
                  contentType: false,
    ...
    confirmRow: function(item){
      ...
      let _this = this;
        ...
        axios({
                ...
                url: 'api/soa_form_quotation_edit_row',
                data: form_Data
            })
    ...
    getRecords: function(keyword) {
      ...
      const params = {
          ...
          axios
              .get('api/soa_form_quotation_mgt', { params, headers: {"Authorization" : `Bearer ${token}`} })
              .then(
              (res) => {
