var app = new Vue({
    ...
    methods: {
      ...
      finish_notes : async function() {
        ...
        let res = await axios({
          method: 'post',
          url: 'api/order_taiwan_mockup_p1_finish_notes',
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
          },
      ...
      sendNotesToTw : async function() {
        ...
        let res = await axios({
          method: 'post',
          url: 'api/order_taiwan_mockup_p1_send_note_tw',
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
          },
      ...
      withdrawNotesToTw : async function() {
        ...
        let res = await axios({
          method: 'post',
          url: 'api/order_taiwan_mockup_p1_withdraw_note_tw',
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
          },
    ...
    do_msg_delete(message_id, task_id) {
      ...
      axios({
        ...
        url: "api/order_taiwan_mockup_p1_delete_message",
        data: form_Data,
      })
        .then(function(response) {
          //handle success
      ...
      reload_task(task_id) {
        ...
        axios
          .get("api/order_taiwan_mockup_p1_message", {
            params,
            headers: { Authorization: `Bearer ${token}` },
          })
          .then(
      ...
      comment_create(task_id) {
        ...
        axios({
          ...
          url: "api/order_taiwan_mockup_p1_message",
          data: form_Data,
        })
          .then(function(response) {
