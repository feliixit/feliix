var app = new Vue({
  ...
  methods: {
    ...
    account_privileges: function() {
      ...
      if(this.record.info_account === 'Office Petty Cash' && (this.name.trim() === 'Mary Jude Jeng Articulo' || this.name.trim() === 'Dennis Lin' || this.name.trim() === 'Ronnie Dela Cruz'))
        return true;
      
      if(this.record.info_account === 'Online Transactions' && (this.name.trim() === 'Mary Jude Jeng Articulo' || this.name.trim() === 'Dennis Lin' || this.name.trim() === 'Ronnie Dela Cruz'))
        return true;
