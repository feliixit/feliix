var app = new Vue({
    ...
    data: {
      ...
      temp_caption: '',
      temp_mode_content: '',
      temp_account_summary: '',
      temp_caption_first_line: '',
      temp_content_first_line: '',
      temp_caption_second_line: '',
      temp_content_second_line: '',
    ...
    product_total:0,
        ...
        transmittal_var_date : '',
        transmittal_var_to : '',
        transmittal_var_from : '',
        transmittal_var_subject : '',
        transmittal_var_remark : '',
        transmittal_var_purpose : [],
 ...
 */
    ...
    filter_apply_new: function() {
      ...
      contact_save: async function() {
        ...
        form_Data.append("contact", this.temp_contact);

        form_Data.append("pixa", this.temp_pixa_t);
        form_Data.append("show", this.temp_show_t);
        form_Data.append("pageless", '');

        try {
          let res = await axios({
            method: 'post',
            url: 'api/transmittal_contact_insert',
            data: form_Data,
            headers: {
              "Content-Type": "multipart/form-data",
            },
      ...
      subtotal_save_changes: async function (id, temp_block) {
        if (this.submit == true) return;
        ...
        try {
          let res = await axios({
            method: 'post',
            url: 'api/transmittal_page_type_block_update',
            data: form_Data,
            headers: {
              "Content-Type": "multipart/form-data",
            },
      ...
      subtotal_save() {
        ...
        this.subtotal_save_changes(this.id, this.temp_block_a);
        this.subtotal_close();
      ...
      subtotal_close() {
        ...
        this.temp_block_a = JSON.parse(JSON.stringify(this.block_a));
        this.temp_block_b = [];
      ...
      export_excel() {
        ...
        axios({
          method: "post",
          url: "api/soa_quotation_export_excel",
          data: form_Data,
          responseType: "blob",
        })
            .then(function(response) {
...
Installation:`;
      ...
      reset_header() {
        ...
        this.transmittal_var_date = this.transmittal_date;
        this.transmittal_var_to = this.transmittal_to;
        this.transmittal_var_from = this.transmittal_from;
        this.transmittal_var_subject = this.transmittal_subject;
        this.transmittal_var_remarks = this.transmittal_remarks;

        this.transmittal_var_purpose = JSON.parse(JSON.stringify(this.transmittal_purpose));
      ...
      save_header() {
        ...
        this.third_line = this.temp_third_line;

        this.statement_date = this.temp_statement_date;
        this.po = this.temp_po;
        this.mode = this.temp_mode;
        this.caption = this.temp_caption;
        this.mode_content = this.temp_mode_content;
        this.account_summary = this.temp_account_summary;
        this.caption_first_line = this.temp_caption_first_line;
        this.caption_second_line = this.temp_caption_second_line;
        this.content_first_line = this.temp_content_first_line;
        this.content_second_line = this.temp_content_second_line;
        ...
        this.transmittal_date = this.transmittal_var_date;
        this.transmittal_to = this.transmittal_var_to;
        this.transmittal_from = this.transmittal_var_from;
        this.transmittal_subject = this.transmittal_var_subject;
        this.transmittal_remark = this.transmittal_var_remark;

        this.transmittal_purpose = JSON.parse(JSON.stringify(this.transmittal_var_purpose));
      ...
      reset: function() {
        ...
        this.caption_first_line = '';
        this.caption_second_line = '';
        this.content_first_line = '';
        this.content_second_line = '';
        ...
        this.temp_third_line = '';
        this.temp_statement_date = '';
        this.temp_po = '';
        this.temp_mode = '';
        this.temp_caption = '';
        this.temp_mode_content = '';
        this.temp_account_summary = '';
        this.temp_caption_first_line = '';
        this.temp_caption_second_line = '';
        this.temp_content_first_line = '';
        this.temp_content_second_line = '';
        ...
        axios
          ...
          .then(function(response) {
            ...
            if (_this.receive_records.length > 0) {
              ...
              _this.third_line = _this.receive_records[0].third_line;

              _this.statement_date = _this.receive_records[0].statement_date;
              _this.po = _this.receive_records[0].po;
              _this.mode = _this.receive_records[0].mode;
              _this.caption = _this.receive_records[0].caption;
              _this.mode_content = _this.receive_records[0].mode_content;
              _this.account_summary = _this.receive_records[0].account_summary;
              _this.caption_first_line = _this.receive_records[0].caption_first_line;
              _this.caption_second_line = _this.receive_records[0].caption_second_line;
              _this.content_first_line = _this.receive_records[0].content_first_line;
              _this.content_second_line = _this.receive_records[0].content_second_line;
              ...
              // contact
              _this.contact = _this.receive_records[0].contact;
              ...
              _this.serial_name = _this.receive_records[0].serial_name;

              _this.transmittal_date = _this.receive_records[0].transmittal_date;
              _this.transmittal_var_date = _this.receive_records[0].transmittal_date;
              _this.transmittal_to = _this.receive_records[0].transmittal_to;
              _this.transmittal_var_to = _this.receive_records[0].transmittal_to;
              _this.transmittal_from = _this.receive_records[0].transmittal_from;
              _this.transmittal_var_from = _this.receive_records[0].transmittal_from;
              _this.transmittal_subject = _this.receive_records[0].transmittal_subject;
              _this.transmittal_var_subject = _this.receive_records[0].transmittal_subject;
              _this.transmittal_remark = _this.receive_records[0].transmittal_remark;
              ...
              if(_this.block_names.length > 0)
              {
                _this.block_a = _this.block_names[0].blocks;
                _this.block_value = _this.block_names[0];
                _this.temp_block_a = JSON.parse(JSON.stringify(_this.block_a));
              }
              ...
              _this.temp_third_line = _this.receive_records[0].third_line;
              _this.temp_statement_date = _this.receive_records[0].statement_date;
              _this.temp_po = _this.receive_records[0].po;
              _this.temp_mode = _this.receive_records[0].mode;
              _this.temp_caption = _this.receive_records[0].caption;
              _this.temp_mode_content = _this.receive_records[0].mode_content;
              _this.temp_account_summary = _this.receive_records[0].account_summary;
              _this.temp_caption_first_line = _this.receive_records[0].caption_first_line;
              _this.temp_caption_second_line = _this.receive_records[0].caption_second_line;
              _this.temp_content_first_line = _this.receive_records[0].content_first_line;
              _this.temp_content_second_line = _this.receive_records[0].content_second_line;
              ...
              // contact
              _this.temp_contact = _this.receive_records[0].contact;
              _this.temp_pixa_t = _this.receive_records[0].pixa_t;
              _this.temp_show_t = _this.receive_records[0].show_t;
      ...
      header_save : function() {
        ...
        form_Data.append("id", this.id);
        form_Data.append("transmittal_date", this.transmittal_date);
        form_Data.append("transmittal_to", this.transmittal_to);
        form_Data.append("transmittal_from", this.transmittal_from);
        form_Data.append("transmittal_subject", this.transmittal_subject);
        form_Data.append("transmittal_remark", this.transmittal_remark);
        form_Data.append("transmittal_purpose", JSON.stringify(this.transmittal_purpose));
        ...
        if(this.id == 0) {
          axios({
            ...
            url: "api/transmittal_header_insert",
            data: form_Data,
          })
            .then(function(response) {
              //handle success
        ...
        if(this.id != 0) {
          axios({
            ...
            url: "api/transmittal_header_update",
            data: form_Data,
          })
            .then(function(response) {
              //handle success
