  ...
  methods: {
    ...
    task_upload_i(batch_id) {
      ...
      myArr.forEach((element, index) => {
        ...
        myForm.append('batch_type', 'other_task_sl');
    ...
    getCreators() {
      ...
      axios
        .get("api/admin/project_creators_sl", {
    ...
    reload_task(task_id) {
      ...
      axios
        .get("api/project03_other_task_sl", {
          params,
          headers: { Authorization: `Bearer ${token}` },
        })
        .then(
    ...
    do_task_duplicate(task_id_to_dup) {
      ...
      axios({
        ...
        url: "api/project03_other_task_dup_sl",
        data: form_Data,
      })
        .then(function(response) {
          //handle success
    ...
    do_task_delete(task_id_to_del) {
      ...
      axios({
        ...
        url: "api/project03_other_task_del_sl",
        data: form_Data,
      })
        .then(function(response) {
          //handle success
    ...
    do_msg_delete(message_id, item_id) {
      ...
      axios({
        ...
        url: "api/project03_delete_message_sl",
        data: form_Data,
      })
        .then(function(response) {
          //handle success
    ...
    task_create() {
      ...
      axios({
        ...
        url: "api/project03_other_task_sl",
        data: form_Data,
      })
        .then(function(response) {
    ...
    task_edit_create() {
      ...
      axios({
        ...
        url: "api/project03_other_task_edit_sl",
        data: form_Data,
      })
        .then(function(response) {
          if (response.data["batch_id"] != 0) {
    ...
    comment_create(task_id) {
      ...
      axios({
        ...
        url: "api/project_other_task_message_sl",
        data: form_Data,
      })
        .then(function(response) {
          if (response.data["batch_id"] != 0) {
    ...
    comment_upload(task_id, batch_id) {
      ...
      myArr.forEach((element, index) => {
        ...
        var data = myArr[index];
        var myForm = new FormData();
        myForm.append("batch_type", "other_task_msg_sl");
        myForm.append("batch_id", batch_id);
        myForm.append("file", data);
    ...
    msg_create(item_id, msg_id) {
      ...
      axios({
        ...
        url: "api/project_other_task_reply_sl",
        data: form_Data,
      })
        .then(function(response) {
          if (response.data["batch_id"] != 0) {
    ...
    msg_upload(item_id, msg_id, batch_id) {
      ...
      myArr.forEach((element, index) => {
        ...
        var data = myArr[index];
        var myForm = new FormData();
        myForm.append("batch_type", "other_task_msg_rep_sl");
        myForm.append("batch_id", batch_id);
        myForm.append("file", data);
    ...
    task_create_o() {
      ...
      axios({
        ...
        url: 'api/project03_other_task_order_sls',
        data: form_Data
      })
        .then(function (response) {
          if (response.data['batch_id'] != 0) {
    ...
    task_edit_create_o() {
      ...
      axios({
        ...
        url: 'api/project03_other_task_edit_order_sls',
        data: form_Data
      })
        .then(function (response) {
          if (response.data['batch_id'] != 0) {
