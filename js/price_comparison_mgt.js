  ...
  */
  ...
  methods:{
    ...
    getUsers () {
      ...
      axios
          .get('api/admin/price_comparison_project_creators', { headers: {"Authorization" : `Bearer ${token}`} })
          .then(
          (res) => {
    ...
    getCreators () {
      ...
      axios
          .get('api/admin/price_comparison_creators', { headers: {"Authorization" : `Bearer ${token}`} })
          .then(
          (res) => {
    ...
    duplicateRow: function(item){
      ...
      Swal.fire({
          title: "Duplicate",
          text: "Are you sure to duplicate this comparison?",
          icon: "info",
          ...
          if (result.value) {
            ...
            let me = _this;
              ...
              $.ajax({
                  url: "api/price_comparison_duplicate",
                  type: "POST",
      ...
      Swal.fire({
          ...
          if (result.value) {
            ...
            let me = _this;
              ...
              //DELETE table_name WHERE ID=id;
              $.ajax({
                  url: "api/price_comparison_delete",
                  type: "POST",
                  contentType: 'multipart/form-data',
                  processData: false,
                  contentType: false,
    ...
    confirmRow: function(item){
      ...
      let _this = this;
        ...
        axios({
                ...
                url: 'api/price_comparison_edit_row',
                data: form_Data
            })
    ...
    getRecords: function(keyword) {
      ...
      const params = {
          ...
          axios
              .get('api/price_comparison_mgt', { params, headers: {"Authorization" : `Bearer ${token}`} })
              .then(
              (res) => {
    ...
    approve: function() {
      ...
      let _this = this;
            ...
            if (this.ins_title.trim() == '') {
              Swal.fire({
                text: 'Please enter Price Comparison Name!',
                icon: 'warning',
                confirmButtonText: 'OK'
              })
            ...
            axios({
                    ...
                    url: 'api/price_comparison_insert',
                    data: form_Data
                })
                .then(function(response) {
                    //handle success
