var app = new Vue({
  ...
  methods: {
    ...
    setTrackingPages () {
      ...
      this.it_paginate(this.it_records);
        },
    ...
    can_access: async function(id) {
      ...
      try {
        let res = await axios.get("api/office_item_can_access_modify", {
          params,
          headers: { Authorization: `Bearer ${token}` },
        });
    ...
    getRecord: async function(id) {
        ...
        if(ret != "")
        {
          ...
          window.location = "inventory_modify_mgt";
          return;
        }
    ...
    export_list: function() {
      ...
      axios({
        method: "post",
        url: "api/office_item_inventory_modify_export",
        data: form_Data,
        responseType: "blob",
      })
        .then(function(response) {
    ...
    export_list3: function() {
      ...
      axios({
        method: "post",
        url: "api/office_item_inventory_modify_stage3_export",
        data: form_Data,
        responseType: "blob",
      })
        .then(function(response) {
    ...
    export_list4: function() {
      ...
      axios({
        method: "post",
        url: "api/office_item_inventory_modify_stage4_export",
        data: form_Data,
        responseType: "blob",
      })
        .then(function(response) {
    ...
    go_to_modify_mgt: function() {
      window.location = "office_item_inventory_modify_mgt";
    },
