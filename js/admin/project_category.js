...
var app = new Vue({
	...
	methods:{
		getReceiveRecords: function() {
            ...
            axios.get('../api/admin/project_category', { params, headers: {"Authorization" : `Bearer ${token}`} })
            .then(
                (res) => {
        ...
        delReceiveRecord: function(id) {
            ...
            axios({
                    ...
                    url: '../api/admin/project_category',
                    data: formData
                })
        ...
        editReceiveRecord: function(event) {
            ...
            {
              this.error_username = '分類需輸入 (category required)';
              $(window).scrollTop(0);
              return false;
            } 

            formData.append('category', this.record.category)
