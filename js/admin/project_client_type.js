...
var app = new Vue({
	...
	methods:{
		getReceiveRecords: function() {
            ...
            axios.get('../api/admin/project_client_type', { params, headers: {"Authorization" : `Bearer ${token}`} })
            .then(
                (res) => {
        ...
        delReceiveRecord: function(id) {
            ...
            axios({
                    ...
                    url: '../api/admin/project_client_type',
                    data: formData
                })
        ...
        editReceiveRecord: function(event) {
            ...
            if (this.record.client_type == "") 
            {
              this.error_username = '客戶分類需輸入 (client type required)';
              $(window).scrollTop(0);
              return false;
            } 
        ...
        createReceiveRecord: function() {
          let _this = this;
            ...
            {
              Swal.fire({
                text: '客戶分類需輸入 (client type required)',
                icon: 'error',
