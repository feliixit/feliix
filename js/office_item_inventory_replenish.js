  ...
  methods: {
    ...
    getRecord: async function(id) {
        ...
        if(ret != "")
        {
          ...
          window.location = "office_item_inventory_replenish_mgt";
          return;
        }
        ...
        axios
          .get("api/office_item_inventory_replenish", {
              params,
              headers: { Authorization: `Bearer ${token}` },
            })
      ...
      save: function(stage, note) {
        ...
        axios({
          ...
          url: "api/office_item_inventory_replenish_save",
          data: form_Data,
        })
          .then(function(response) {
            //handle success
    ...
    export_list: function() {
      ...
      axios({
        method: "post",
        url: "api/office_item_inventory_replenish_export",
        data: form_Data,
        responseType: "blob",
      })
        .then(function(response) {
    ...
    export_list3: function() {
      ...
      axios({
        method: "post",
        url: "api/office_item_inventory_replenish_stage3_export",
        data: form_Data,
        responseType: "blob",
      })
        .then(function(response) {
    ...
    export_list4: function() {
      ...
      axios({
        method: "post",
        url: "api/office_item_inventory_replenish_stage4_export",
        data: form_Data,
        responseType: "blob",
      })
        .then(function(response) {
