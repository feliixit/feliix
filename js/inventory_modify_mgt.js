var app = new Vue({
  ...
  methods: {
    ...
    getAccess: function() {
      ...
      axios({
          ...
          url: 'api/inventory_modify_access_control',
          data: form_Data
      })
      .then(function(response) {
          //handle success
          _this.inventory_modify = response.data.inventory_modify;
    ...
    Swal.fire({
        ...
        if (result.value) {
          ...
          let me = _this;
            ...
            $.ajax({
                url: "api/inventory_modify_mgt_duplicate",
                type: "POST",
  ...
  check_valid: function(status, checker, approver){
    ...
    {
      ret_msg = "For inventory modification record with PHASE 2: Inventory Modification Completed, no one is allowed to delete it.";
    }
  ...
  deleteRow: function(item){
    ...
    let ret_msg = this.check_valid(item['status'], this.inventory_modify, this.is_approver);
    ...
    Swal.fire({
        ...
        if (result.value) {
          ...
          let me = _this;
            ...
            //DELETE table_name WHERE ID=id;
            $.ajax({
                url: "api/inventory_modify_mgt_delete",
                type: "POST",
                contentType: 'multipart/form-data',
                processData: false,
                contentType: false,
  ...
  confirmRow: function(item){
    ...
    let _this = this;
      ...
      axios({
              ...
              url: 'api/inventory_modify_mgt_edit_row',
              data: form_Data
          })
          .then(function(response) {
              //handle success
...
*/
    ...
    approve: function() {
      ...
      axios({
        ...
        url: "api/inventory_modify_insert",
        data: form_Data,
      })
      .then(function(response) {
        //handle success
    ...
    getCreators() {
      ...
      axios
        .get("api/admin/inventory_modify_creators", {
          headers: { Authorization: `Bearer ${token}` },
        })
        .then(
          (res) => {
    ...
    getCheckers() {
      ...
      axios
        .get("api/admin/inventory_modify_checkers", {
          headers: { Authorization: `Bearer ${token}` },
        })
        .then(
          (res) => {
    ...
    getApprovers() {
      ...
      axios
        .get("api/admin/inventory_modify_approvers", {
          headers: { Authorization: `Bearer ${token}` },
        })
        .then(
          (res) => {
