...
*/
    ...
    getLeaveCredit: function(id) {
      ...
      axios
        .get("api/monthly_new_project_report", {
          params,
    ...
    export_petty() {
      ...
      axios({
        method: "post",
        url: "api/monthly_new_project_report_print",
        data: form_Data,
        responseType: "blob",
      })
          .then(function(response) {
                ...
                link.href = url;
                  ...
                  link.setAttribute('download', 'Monthly New Project Report.xlsx');
