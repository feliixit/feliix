var app = new Vue({
    ...
    methods: {
      ...
      finish_notes : async function() {
        ...
        let res = await axios({
          method: 'post',
          url: 'api/order_taiwan_stock_p1_finish_notes',
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
          },
      ...
      approval : async function() {
        ...
        let res = await axios({
          method: 'post',
          url: 'api/order_taiwan_stock_p1_approval',
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
          },
      ...
      sendNotesToTw : async function() {
        ...
        let res = await axios({
          method: 'post',
          url: 'api/order_taiwan_stock_p1_send_note_tw',
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
          },
      ...
      withdrawNotesToTw : async function() {
        ...
        let res = await axios({
          method: 'post',
          url: 'api/order_taiwan_stock_p1_withdraw_note_tw',
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
          },
