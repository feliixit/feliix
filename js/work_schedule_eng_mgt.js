...
var app = new Vue({
    ...
    methods:{
        ...
        getCreators () {
            ...
            axios
            .get('api/admin/work_schedule_eng_creators', { headers: {"Authorization" : `Bearer ${token}`} })
            .then(
                (res) => {
        ...
        editRow:function(item){
            ...
            this.pre_data.quotation_id = item.quotation_id; 
        ...
        duplicateRow: function(item){
            ...
            Swal.fire({
                title: "Duplicate",
                text: "Are you sure to duplicate this schedule?",
                icon: "info",
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "api/work_schedule_eng_duplicate",
                        type: "POST",
        ...
        deleteRow: function(item){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    //DELETE table_name WHERE ID=id;
                    $.ajax({
                        url: "api/work_schedule_eng_delete",
                        type: "POST",
                        contentType: 'multipart/form-data',
                        processData: false,
                        contentType: false,
        ...
        confirmRow: async function(item){
            ...
            if(res.length == 0) {
                Swal.fire({
                    text: "Please Input Valid Related Engineering Quotation's ID!",
                    icon: 'warning',
                    confirmButtonText: 'OK'
                })
                return;
            ...
            form_Data.append('quotation_id', project_id);
            ...
            axios({
                ...
                url: 'api/work_schedule_eng_edit_row',
                data: form_Data
            })
        ...
        cancelRow: function(item){
            ...
            item['quotation_id'] = this.pre_data.quotation_id;
        ...
        getRecords: function(keyword) {
            ...
            axios
            .get('api/work_schedule_eng_mgt', { params, headers: {"Authorization" : `Bearer ${token}`} })
            .then(
                (res) => {
        ...
        approve: async function() {
            ...
            res = await this.CheckQuotationEng(this.ins_project_id);
            if(res.length == 0) {
                Swal.fire({
                    text: "Please Input Valid Related Engineering Quotation's ID!",
                    icon: 'warning',
            ...
            form_Data.append("jwt", token);
            form_Data.append('quotation_id', _this.ins_project_id);
        ...
        CheckQuotationEng: async function(id) {
            let _this = this;
            let res = await axios.get('api/quotation_eng_pageless_existed', { params: { id: id } });
            return res.data;
        },
