(function ($) {
  ...
  var generateOption = {
    ...
    a: function (img, text, classes, inline) {
    ...
    img: function (item) {
      ...
      if (item.img == null) {
        ...
        imgElement.setAttribute("style", "width: 60px; margin-right: 15px;");
    ...
    buildData: function () {
      ...
      function addOption (option, config) {
        ...
        if (config.divider) {
          ...
          config.img = option.getAttribute('data-thumbnail');
