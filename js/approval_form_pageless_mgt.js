  ...
  methods:{
    ...
    confirmRow: function(item){
      ...
      let _this = this;
        ...
        axios({
                ...
                url: 'api/approval_form_quotation_edit_row',
                data: form_Data
            })
    ...
    getRecords: function(keyword) {
      ...
      const params = {
          ...
          axios
              .get('api/approval_form_pageless_quotation_mgt', { params, headers: {"Authorization" : `Bearer ${token}`} })
              .then(
              (res) => {
    ...
    approve: function() {
      ...
      let _this = this;
            ...
            if (this.ins_title.trim() == '') {
              Swal.fire({
                text: 'Please Encode Approval Form Name!',
                icon: 'warning',
                confirmButtonText: 'OK'
              })
