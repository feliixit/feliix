  ...
  methods: {
    ...
    apply: function() {
      ...
      axios({
        ...
        url: "api/store_sales_recorder_add",
        data: form_Data,
      })
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          axios({
            ...
            url: "api/store_sales_recorder_del",
            data: form_Data,
          })
            .then(function(response) {
              //handle success
        ...
        .then(
          (res) => {
            ...
            _this.items.forEach((element, index) => {
              ...
              _this.allCashOut += parseFloat(element.discount == '' ? 0 : element.discount);
            });
