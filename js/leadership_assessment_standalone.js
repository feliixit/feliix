  ...
  created() {
    ...
    if (uri.length >= 2) {
      ...
      vars.forEach(async function(v) {
        // token is behind token=
        _this.token = v.replace("token=", "");
  ...
  methods: {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          axios({
            ...
            url: "api/leadership_assessment_review_complete_standalone",
            data: form_Data,
          })
            .then(function(response) {
              //handle success
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          axios({
            ...
            url: "api/leadership_assessment_review_update_standalone",
            data: form_Data,
          })
            .then(function(response) {
              //handle success
    ...
    filter_apply: function(pg) {
      ...
      window.location.href =
        "leadership_assessment_standalone?" + "token=" + _this.token;
    },
    ...
    async getLeadershipAssessmentReview() {
      ...
      var res = await axios({
        method: "get",
        params,
        url: "api/leadership_assessment_review_standalone",
    ...
    to_next: async function(to_period) {
      ...
      form_Data.append("period", to_period);
        ...
        let res = await axios({
          method: 'post',
          url: 'api/leadership_assessment_review_next_standalone',
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
          },
     ...
     get_questions: async function(step) {
      ...
      var res = await axios({
        ...
        params,
        url: "api/leadership_assessment_questions_standalone",
    ...
    getLeaveCredit: function() {
      ...
      axios
        .get("api/leadership_assessment_standalone", {
          params,
        })
        .then(function(response) {
          console.log(response.data);
          ...
          if (_this.receive_records.length > 0) {
            ...
            _this.username = _this.receive_records[0].username;
            _this.email = _this.receive_records[0].email;
            _this.execute();
            if (_this.pg !== 0) {
              _this.page = _this.pg;
              _this.setPages();
