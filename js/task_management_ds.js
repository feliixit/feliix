...
var app = new Vue({
  ...
  methods: {
    ...
    getCreators() {
      ...
      axios
        .get("api/admin/project_creators_d", {
    ...
    reload_task(task_id) {
      ...
      axios
        .get("api/project03_other_task_d", {
          params,
          headers: { Authorization: `Bearer ${token}` },
        })
        .then(
    ...
    do_task_duplicate(task_id_to_dup) {
      ...
      axios({
        ...
        url: "api/project03_other_task_dup_d",
        data: form_Data,
      })
        .then(function(response) {
          //handle success
    ...
    do_task_delete(task_id_to_del) {
      ...
      axios({
        ...
        url: "api/project03_other_task_del_d",
        data: form_Data,
      })
        .then(function(response) {
          //handle success
    ...
    do_msg_delete(message_id, item_id) {
      ...
      axios({
        ...
        url: "api/project03_delete_message_d",
        data: form_Data,
      })
        .then(function(response) {
          //handle success
    ...
    task_create() {
      ...
      axios({
        ...
        url: "api/project03_other_task_d",
        data: form_Data,
      })
        .then(function(response) {
    ...
    task_upload(batch_id) {
      ...
      myArr.forEach((element, index) => {
        ...
        myForm.append("batch_type", "other_task_d");
    ...
    task_edit_create() {
      ...
      axios({
        ...
        url: "api/project03_other_task_edit_d",
        data: form_Data,
      })
        .then(function(response) {
          if (response.data["batch_id"] != 0) {
    ...
    comment_create(task_id) {
      ...
      axios({
        ...
        url: "api/project_other_task_message_d",
        data: form_Data,
      })
        .then(function(response) {
          if (response.data["batch_id"] != 0) {
    ...
    comment_upload(task_id, batch_id) {
      ...
      myArr.forEach((element, index) => {
        ...
        var data = myArr[index];
        var myForm = new FormData();
        myForm.append("batch_type", "other_task_msg_d");
        myForm.append("batch_id", batch_id);
        myForm.append("file", data);
    ...
    msg_create(item_id, msg_id) {
      ...
      axios({
        ...
        url: "api/project_other_task_reply_d",
        data: form_Data,
      })
        .then(function(response) {
          if (response.data["batch_id"] != 0) {
    ...
    msg_upload(item_id, msg_id, batch_id) {
      ...
      myArr.forEach((element, index) => {
        ...
        var data = myArr[index];
        var myForm = new FormData();
        myForm.append("batch_type", "other_task_msg_rep_d");
        myForm.append("batch_id", batch_id);
        myForm.append("file", data);
