    ...
    filter_apply_new: function() {
      ...
      sig_save: async function() {
        ...
        try {
          let res = await axios({
            method: 'post',
            url: 'api/soa_quotation_sig_insert',
            data: form_Data,
            headers: {
              "Content-Type": "multipart/form-data",
            },
      ...
      balance_save: async function() {
        ...
        try {
          let res = await axios({
            method: 'post',
            url: 'api/soa_quotation_term_insert',
            data: form_Data,
            headers: {
              "Content-Type": "multipart/form-data",
            },
      ...
      approval_form_post : async function() {
        ...
        let res = await axios({
          method: 'get',
          url: 'api/soa_approval_form_pageless',
          params: parameters,
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
      ...
      contact_save: async function() {
        ...
        try {
          let res = await axios({
            method: 'post',
            url: 'api/soa_quotation_contact_insert',
            data: form_Data,
            headers: {
              "Content-Type": "multipart/form-data",
            },
      ...
      payment_term_save: async function() {
        ...
        try {
          let res = await axios({
            method: 'post',
            url: 'api/soa_quotation_payment_term_insert',
            data: form_Data,
            headers: {
              "Content-Type": "multipart/form-data",
            },
      ...
      save_total: async function() {
        ...
        axios({
          ...
          url: "api/soa_quotation_total_insert",
          data: form_Data,
        })
          .then(function(response) {
            //handle success
      ...
      subtotal_save_changes: async function (id, type_id, temp_block) {
        ...
        try {
          let res = await axios({
            method: 'post',
            url: 'api/soa_quotation_page_type_block_update',
            data: form_Data,
            headers: {
              "Content-Type": "multipart/form-data",
            },
...
Installation:`;
      ...
      header_save : function() {
        ...
        form_Data.append("third_line", this.third_line);
        form_Data.append("statement_date", this.statement_date);
        ...
        form_Data.append("mode_content", this.mode_content);
        form_Data.append("account_summary", this.account_summary);
        form_Data.append("caption_first_line", this.caption_first_line);
        form_Data.append("content_first_line", this.content_first_line);
        form_Data.append("caption_second_line", this.caption_second_line);
        form_Data.append("content_second_line", this.content_second_line);
        ...
        if(this.id == 0) {
          axios({
            ...
            url: "api/soa_quotation_header_insert",
            data: form_Data,
          })
            .then(function(response) {
              //handle success
        ...
        if(this.id != 0) {
          axios({
            ...
            url: "api/soa_quotation_header_update",
            data: form_Data,
          })
            .then(function(response) {
              //handle success
      ...
      footer_save : function() {
        ...
        if(this.id == 0) {
          axios({
            ...
            url: "api/soa_quotation_footer_insert",
            data: form_Data,
          })
            .then(function(response) {
              //handle success
        ...
        if(this.id != 0) {
          axios({
            ...
            url: "api/soa_quotation_footer_update",
            data: form_Data,
          })
            .then(function(response) {
              //handle success
      ...
      page_copy_save: async function(id, type_id, temp_block, page) {
        ...
        let res = await axios({
          method: 'post',
          url: 'api/soa_quotation_page_update',
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
          },
        ...
        let res1 = await axios({
          method: 'post',
          url: 'api/soa_quotation_page_type_block_update_copy',
          data: form_Data1,
          headers: {
            "Content-Type": "multipart/form-data",
          },
