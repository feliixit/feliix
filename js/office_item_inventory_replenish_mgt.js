var app = new Vue({
  ...
  duplicateRow: function(item){
    ...
    Swal.fire({
        title: "Duplicate",
        text: "Are you sure to duplicate this inventory replenishment record?",
        icon: "info",
        ...
        if (result.value) {
          ...
          let me = _this;
            ...
            $.ajax({
                url: "api/office_item_inventory_replenish_mgt_duplicate",
                type: "POST",
    ...
    Swal.fire({
        ...
        if (result.value) {
          ...
          let me = _this;
            ...
            //DELETE table_name WHERE ID=id;
            $.ajax({
                url: "api/office_item_inventory_replenish_mgt_delete",
                type: "POST",
                contentType: 'multipart/form-data',
                processData: false,
                contentType: false,
  ...
  confirmRow: function(item){
    ...
    let _this = this;
      ...
      axios({
              ...
              url: 'api/office_item_inventory_replenish_mgt_edit_row',
              data: form_Data
          })
          .then(function(response) {
              //handle success
...
*/
    ...
    getLeaveCredit: function(id) {
      ...
      axios
        .get("api/office_item_inventory_replenish_mgt", {
          params,
    ...
    filter_apply_new: function(pg) {
      ...
      window.location.href =
        "office_item_inventory_replenish_mgt?" +
        "fru=" +
    ...
    approve: function() {
      ...
      axios({
        ...
        url: "api/office_item_inventory_replenish_insert",
        data: form_Data,
      })
      .then(function(response) {
        //handle success
    ...
    getCreators() {
      ...
      axios
        .get("api/admin/office_item_inventory_replenish_creators", {
          headers: { Authorization: `Bearer ${token}` },
        })
        .then(
          (res) => {
    ...
    getCheckers() {
      ...
      axios
        .get("api/admin/office_item_inventory_replenish_checkers", {
          headers: { Authorization: `Bearer ${token}` },
        })
        .then(
          (res) => {
    ...
    getApprovers() {
      ...
      axios
        .get("api/admin/office_item_inventory_replenish_approvers", {
          headers: { Authorization: `Bearer ${token}` },
        })
        .then(
          (res) => {
