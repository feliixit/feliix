...
out : "",
    ...
    methods: {
      ...
      getOdMain: function() {
        ...
        const params = {
            ...
            axios
                .get('api/inquiry_mgt', { params, headers: {"Authorization" : `Bearer ${token}`} })
                .then(
                (res) => {
                    _this.iq_name = res.data[0].iq_name;
      ...
      finish_notes : async function() {
        ...
        let res = await axios({
          method: 'post',
          url: 'api/inquiry_taiwan_p1_finish_notes',
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
          },
      ...
      approval : async function() {
        ...
        let res = await axios({
          method: 'post',
          url: 'api/inquiry_taiwan_p1_approval',
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
          },
      ...
      sendNotesToTw : async function() {
        ...
        let res = await axios({
          method: 'post',
          url: 'api/inquiry_taiwan_p1_send_note_tw',
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
          },
      ...
      withdrawNotesToTw : async function() {
        ...
        {
          Swal.fire({
            text: "Only the user who submitted the inquiry can withdraw the inquiry.",
            icon: "info",
            confirmButtonText: "OK",
          });
        ...
        let res = await axios({
          method: 'post',
          url: 'api/inquiry_taiwan_p1_withdraw_note_tw',
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
          },
    ...
    getCreators () {
      ...
      quotation_import: async function(item) {
        ...
        let res = await axios({
          method: 'post',
          url: 'api/inquiry_taiwan_p1_quotation_import',
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
          },
    ...
    do_msg_delete(message_id, task_id) {
      ...
      axios({
        ...
        url: "api/inquiry_taiwan_p1_delete_message",
        data: form_Data,
      })
        .then(function(response) {
          //handle success
      ...
      got_it_message(message_id, task_id) {
        ...
        axios({
          ...
          url: 'api/inquiry_taiwan_p1_got_it',
          data: form_Data
        })
          .then(function (response) {
            _this.reload_task(task_id);
      ...
      do_item_delete(id) {
        ...
        axios({
          ...
          url: "api/inquiry_taiwan_p1_delete_item",
          data: form_Data,
        })
          .then(function(response) {
            //handle success
      ...
      reload_task(task_id) {
        ...
        axios
          .get("api/inquiry_taiwan_p1_message", {
            params,
            headers: { Authorization: `Bearer ${token}` },
          })
          .then(
      ...
      comment_create(task_id) {
        ...
        axios({
          ...
          url: "api/inquiry_taiwan_p1_message",
          data: form_Data,
        })
          .then(function(response) {
      ...
      comment_upload(task_id, batch_id) {
        ...
        myArr.forEach((element, index) => {
          ...
          myForm.append("batch_type", "iq_message");
      ...
      taskItems(task_id) {
        ...
        confirmItem(item) {
            ...
            axios({
              ...
              url: "api/inquiry_taiwan_p1_item_update",
              data: form_Data,
            })
              .then(function(response) {
                //handle success
      ...
      getUserName: function() {
        ...
        .then(function(response) {
            ...
            if(_this.name.toLowerCase().trim() == 'ariel lin')
              _this.is_ariel = true;
      ...
      page_up: async function(fromIndex, eid) {
        ...
        let res = await axios({
          method: 'post',
          url: 'api/inquiry_taiwan_p1_swap_item',
          data: form_Data,
          headers: {
            "Content-Type": "multipart/form-data",
          },
      ...
      show_page_up: function(item)
      {
        ...
        // if(item.create_id != 48)
        //   is_show = false;

        return is_show;
      },

      show_page_down: function(item)
      {
        var is_show = true;
      ...
      show_edit: function(item)
      {
        ...
        if(item.create_id != 48 && this.status == 1)
          is_show = false;
      ...
      do_print_me(item, text){
        ...
        html2canvas(document.querySelector(cls), { proxy: "html2canvasproxy", useCORS: false, logging: true, allowTaint: true}).then(canvas => {
          ...
          axios
            .post("api/inquiry_taiwan_p1_snapshot", data, {
              headers: {
      ...
      export_petty() {
        ...
        axios({
          method: "post",
          url: "api/inquiry_taiwan_p1_print",
          data: form_Data,
          responseType: "blob",
        })
            .then(function(response) {
                  ...
                  link.href = url;
                    ...
                    link.setAttribute('download', 'Inquiry Taiwan.xlsx');
