        ...
        if (tmp.length == 2) {
          switch (tmp[0]) {
            ...
            case "tp":
              ...
              break;
            case "op1":
              _this.iq_opt1 = decodeURI(tmp[1]);
              break;
            case "od1":
              _this.iq_ord1 = decodeURI(tmp[1]);
              break;
            case "op2":
              _this.iq_opt2 = decodeURI(tmp[1]);
              break;
            case "od2":
              _this.iq_ord2 = decodeURI(tmp[1]);
              break;
            case "id":
              _this.id = tmp[1];
              break;
      ...
      axios({
        ...
        getAllRecords: function() {
          ...
          const params = {};
              ...
              axios
                  .get('api/inquiry_mgt_all', { params, headers: {"Authorization" : `Bearer ${token}`} })
                  .then(
                  (res) => {
