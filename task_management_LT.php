...
try {
    ...
    {
        if(trim(strtoupper($position)) == 'LIGHTING VALUE CREATION DIRECTOR' || trim(strtoupper($position)) == 'ASSISTANT LIGHTING VALUE CREATION DIRECTOR')
        {
            $access6 = true;
        }
    }
    ...
    if(trim(strtoupper($username)) == 'DERECK' || trim(strtoupper($username)) == 'GWENDOLYN SARMIENTO' || trim($username) == 'Kulay Avendaño')
    {
        $access6 = true;
    }
