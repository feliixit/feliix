...
try {
    ...
    {
        if(trim(strtoupper($position)) == 'LIGHTING MANAGER' || trim(strtoupper($position)) == 'ASSISTANT LIGHTING MANAGER')
        {
            $access6 = true;
        }
    }
    ...
    if(trim(strtoupper($username)) == 'DERECK')
    {
        $access6 = true;
    }
                    ...
                    <div class="teskbox dialogclear" style="margin-top:-2px !important">
                        <div class="tablebox m01">
                            ...
                            <ul v-if="receive_record.order.length > 0">
                                ...
                                <li><a style="color: #25a2b8" :href="(receive_record.order[0].order_type == 'stock' ? 'order_taiwan_stock_p1' : 'order_taiwan_p1') + '?id=' + receive_record.order[0].id">{{ receive_record.order[0].serial_name }}</a></li>
                            </ul>
...
<script type="text/javascript" src="js/task_management_lt.js" defer></script>
