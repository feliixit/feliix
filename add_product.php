...
<head>
    ...
    <style>
        ...
        #modal_bulk_apply, #modal_edit_name, #modal_quick_assign, #modal_quick_assign2_1 {
            position: fixed;
            top: 30px;
            left: 0;
            right: 0;
        ...
        #modal_bulk_apply > .modal-content, #modal_edit_name > .modal-content, #modal_quick_assign > .modal-content, #modal_quick_assign2_1 > .modal-content {
            width: 700px;
        ...
        #modal_bulk_apply > .modal-content, #modal_quick_assign > .modal-content, #modal_quick_assign2_1 > .modal-content{
            width: 600px;
        }

        #modal_bulk_apply, #modal_edit_name, #modal_quick_assign, #modal_quick_assign2_2 {
            position: fixed;
            top: 30px;
            left: 0;
            right: 0;
        ...
        #modal_bulk_apply > .modal-content, #modal_edit_name > .modal-content, #modal_quick_assign > .modal-content, #modal_quick_assign2_2 > .modal-content {
            width: 700px;
            max-height: calc( 100vh - 60px);
            margin: auto;
            border: 3px solid #E2E2E2;
        ...
        #modal_bulk_apply > .modal-content, #modal_quick_assign > .modal-content, #modal_quick_assign2_2 > .modal-content{
            width: 600px;
        }

        #modal_bulk_apply, #modal_edit_name, #modal_quick_assign, #modal_quick_assign2_3 {
            position: fixed;
            top: 30px;
            left: 0;
            right: 0;
        ...
        #modal_bulk_apply > .modal-content, #modal_edit_name > .modal-content, #modal_quick_assign > .modal-content, #modal_quick_assign2_3 > .modal-content {
            width: 700px;
            max-height: calc( 100vh - 60px);
            margin: auto;
            border: 3px solid #E2E2E2;
        ...
        #modal_bulk_apply > .modal-content, #modal_quick_assign > .modal-content, #modal_quick_assign2_3 > .modal-content{
            width: 600px;
        }
    ...
    <div id="app" class="mainContent">
        ...
        <div class="region" v-if="edit_mode == true">
            ...
            <ul class="NTD_price">
                ...
                <li>
                    <input type="text" class="form-control one_half" v-model="price_ntd">
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    <input type="text" class="form-control one_half" v-model="price">
                </li>
            </ul>
            ...
            <div style="width: 100%; overflow-x: auto; margin-top: 10px;">
                <table id="tb_product_variants" class="table_template">
                    ...
                    <tr v-for="(item, index) in variation_product" >
                        ...
                        <td class="NTD_price"><input type="number" class="form-control" v-model="item.price_ntd"></td>
