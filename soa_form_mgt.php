...
if($user_id == 1 || $user_id == 2 || $user_id == 6 || $user_id == 3 || $user_id == 89 || $user_id == 129 || $user_id == 137 || $user_id == 138 || $user_id == 148 || $user_id == 146 || $user_id == 190 || $user_id == 191 || $user_id == 195 || $user_id == 198)
$test_manager = "1";
}
...
?>
                    <div id="insert_dialog" class="dialog d-add">
                        <h6>Create New Statement of Account:</h6>
                        <div class="formbox">
                            <dl>
                                <dt>Name of SOA</dt>
                    ...
                    <div id="filter_dialog" class="dialog d-filter"><h6>Filter Function:</h6>
                        <div class="formbox">
                            <dl>
                                ...
                                <dt>Keyword (for name of SOA, project name or quotation no.)</dt>
            ...
            <div class="tableframe">
                <div class="tablebox lv1">
                    ...
                    <ul v-for='(receive_record, index) in displayedPosts'>
                        <li>
                            <a v-show="receive_record.is_edited == 1" v-bind:href="'soa?id=' + receive_record.id">{{
...
<script defer src="js/soa_form_mgt.js"></script>
