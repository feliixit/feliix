...
try{
    ...
    order_type_notification($user_name, 'access1,access3', 'access2,access4,access5', $project_name, $serial_name, $od_name, 'Order - Stocks', $comment, $action, $items_array, $od_id, "stock");
