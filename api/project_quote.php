  ...
  try {
      ...
      switch ($method) {
          case 'GET':
            ...
            $sql = "SELECT pm.id, pm.remark, u.username, pm.created_at FROM project_quotation pm left join user u on u.id = pm.create_id  where project_id = " . $pid . " and pm.status <> -1 ";
