...
else
{
    try {
        ...
        knowledge_add_notification($user_name, date("Y/m/d") . " " . date("h:i:sa"),  $users, $cc, $title, $user_name, date("Y/m/d") . " " . date("h:i:sa") , category_text($category), type_text($type), duration_text($duration), $last_id, "add");
