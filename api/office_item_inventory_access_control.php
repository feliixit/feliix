...
switch ($method) {
    case "GET":
        ...
        $ret = GetAccess("inventory_checker", $GLOBALS["user_name"], $db);
        $access["inventory_checker"] = $ret;
        $ret = GetAccess("inventory_approver", $GLOBALS["user_name"], $db);
        $access["inventory_approver"] = $ret;
