    ...
    switch ($method) {
        ...
        case 'POST':
            ...
            try {
                ...
                $query = "delete from electrical_materials where status = -1";
                $stmt = $db->prepare($query);
                $stmt->execute();

                // petty_list
                $query = "update electrical_materials
                set status = -1";
                ...
                for ($i = 0; $i < count($petty_array); $i++) {
                    ...
                    $query = "INSERT INTO electrical_materials
                    SET
                    `sn` = :sn,
                    `unit` = :unit,
