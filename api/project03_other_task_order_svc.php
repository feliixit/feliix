...
function SendNotifyMail($last_id, $stage_id, $order_type, $order_name)
{
    ...
    task_notify_type_order("create", $project_name, $task_name, $stages, $create_id, $assignee, $collaborator, $due_date, $detail, $last_id, $created_at, GetOrderType($order_type), $order_name, "SVC");
