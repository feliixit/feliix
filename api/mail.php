    ...
    <div style="width: 766px; padding: 25px 70px 20px 70px; border: 2px solid rgb(230,230,230); color: black;">
        ...
        <table style="margin-left: 15px; width: 96%;">
            ...
            <tr>
                ...
                <td style="border-left: 1px solid #94BABB; border-bottom: 2px solid #94BABB; padding: 8px; font-size: 14px; text-align: center; width: 440px; border-bottom-right-radius: 9px;">
                    ';
                    $content = $content . $items[$i]['code'] . '';
                    $content = $content . '
                </td>
