    ...
    case 'POST':
        ...
        try {
            for($i = 0; $i < count($items); $i++)
            {
                ...
                updateOrderReceiveItem($db, $item_id, $receive_id, $user_id);
...
function updateOrderReceiveItem($db, $item_id, $receive_id, $user_id) {
    $query = "update order_receive_item
            SET
                qty = qty - 1,
                updated_id = :updated_id,
                updated_at = now()
            where item_id = :item_id and receive_id = :receive_id;";
