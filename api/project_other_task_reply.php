...
switch ($method) {
    ...
    case 'POST':
        ...
        $query = "INSERT INTO project_other_task_message_reply
        SET
            `message_id` = :msg_id,
            `message` = :message,
...
function SendNotifyMail($last_id, $uid)
{
    ...
    message_notify("create", $project_name, $task_name, $stages, $create_id, $assignee, $collaborator, "", $detail, $stage_id, $msg, $username, $created_at, $_id);
