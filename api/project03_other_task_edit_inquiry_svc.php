...
function SendNotifyMail01($last_id, $old_status_id, $order_type, $order_name)
{
    ...
    task_notify01_type_inquiry($old_status, $task_status, $project_name, $task_name, $stages, $stages_status, $create_id, $assignee, $collaborator, $due_date, $detail, $last_id, $order_type, $order_name, "SVC");
...
function SendNotifyMail02($last_id, $old_status_id, $order_type, $order_name)
{
    ...
    task_notify02_type_inquiry($old_status, $task_status, $project_name, $task_name, $stages, $stages_status, $create_id, $assignee, $collaborator, $due_date, $detail, $last_id, $order_type, $order_name, "SVC");
