...
switch ($method) {
    case 'GET':
        ...
        if($strDate == '')
        {
            ...
            $start    = new DateTime($this_year . '-01-01');
            $end      = new DateTime($this_year . '-12-31');
            ...
            foreach ($period as $dt) {
                ...
                $merged_results[] =  GetOneMonth($dt->format("Y-m-d"), $sale_person, $category, $db);
            }
        ...
        echo json_encode($total1, JSON_UNESCAPED_SLASHES);
