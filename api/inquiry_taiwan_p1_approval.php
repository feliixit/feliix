...
// update main table
$query = "UPDATE iq_main SET `updated_id` = :updated_id,  `updated_at` = now() WHERE id = :id";
...
try{
    ...
    order_notification($user_name, 'access3', 'access1, access2', $project_name, $serial_name, $iq_name, 'Order - Taiwan', $comment, $action, $items_array, $iq_id);
