...
try{
    ...
    order_type_notification03($user_name, 'access1,access2,access3,access4,access5', '', $project_name, $serial_name, $od_name, 'Order - Stocks', $message, 'new_message_22', $items, $od_id, "stock");
