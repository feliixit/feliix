...
if($jwt){ 
    ...
    try {
        ...
        // response in json format
            ...
            $sql = "SELECT account, created_at, category, sub_category, project_name, related_account, details, pic_url, payee, payee_other, paid_date, cash_in, cash_out, remarks from price_record_salary where is_enabled = true";
            $sql1 = "";
            $sql2 = "";
            $sql3 = "";
            ...
            foreach($merged_results as $row)
            {
                ...
                $sheet->setCellValue('E' . $i, ($row['payee'] == 'Other' ? $row['payee_other'] : $row['payee']));
