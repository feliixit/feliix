...
if($block_array[$i]['photo3'] == '')
{
    $query .= " `photo3` = '', ";
                ...
                if($page == 3 && $access2 == 'true')
                    order_type_notification04($user_name, 'access1,access3,access4,access5', '', $project_name, $serial_name, $od_name, 'Order - Stocks', '', 'new_message_23', $item_array, $od_id, "stock");
