...
switch ($method) {
    ...
    case 'POST':
        ...
        order_type_notification03($user_name, 'access1,access2,access3,access4,access5', '', $project_name, $serial_name, $od_name, 'Order - Stocks', $message, 'new_message_21', $items, $od_id, "stock");
