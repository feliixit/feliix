...
$new_info_category = (isset($_POST['new_info_category']) ?  $_POST['new_info_category'] : '');
$org_info_category = (isset($_POST['org_info_category']) ?  $_POST['org_info_category'] : '');
$new_info_sub_category = (isset($_POST['new_sub_category']) ?  $_POST['new_sub_category'] : '');
$org_info_sub_category = (isset($_POST['org_sub_category']) ?  $_POST['org_sub_category'] : '');

$org_info_remark = (isset($_POST['org_info_remark']) ?  $_POST['org_info_remark'] : '');
$new_info_remark = (isset($_POST['new_info_remark']) ?  $_POST['new_info_remark'] : '');
$org_info_remark_other = (isset($_POST['org_info_remark_other']) ?  $_POST['org_info_remark_other'] : '');
$new_info_remark_other = (isset($_POST['new_info_remark_other']) ?  $_POST['new_info_remark_other'] : '');
...
if (!isset($jwt)) {
    ...
    try {
        ...
        $stmt->bindParam(':info_category', $new_info_category);
        $stmt->bindParam(':info_sub_category', $new_info_sub_category);
        $stmt->bindParam(':info_remark', $new_info_remark);
        $stmt->bindParam(':info_remark_other', $new_info_remark_other);
