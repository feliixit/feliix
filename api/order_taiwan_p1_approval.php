...
try{
    ...
    if(count($c_items) > 0)
        order_notification($user_name, 'access3', 'access1, access2', $project_name, $serial_name, $od_name, 'Order - Close Deal', $comment, $action, $c_items, $od_id);

    if(count($w_items) > 0)
        order_notification_warehouse($user_name, 'access1, access3, access4, access5', 'access2', $project_name, $serial_name, $od_name, 'Order - Close Deal', $comment, $action, $w_items, $od_id, $access7);
