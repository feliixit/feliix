...
foreach($return_result as $row)
{
    ...
    $sheet->setCellValue('F' . $i, $row['final_amount'] == '' ? '' : number_format((float)$row['final_amount'], 2, '.', ''));
    $sheet->setCellValue('G' . $i, $row['tax_withheld'] == '' ? '' : number_format((float)$row['tax_withheld'], 2, '.', ''));
    $sheet->setCellValue('H' . $i, $row['down_payment_amount'] == '' ? '' : number_format((float)$row['down_payment_amount'], 2, '.', ''));
    $sheet->setCellValue('I' . $i, $row['payment_amount'] == '' ? '' : number_format((float)$row['payment_amount'], 2, '.', ''));
    $sheet->setCellValue('J' . $i, $row['ar'] == '' ? '' : number_format((float)$row['ar'], 2, '.', ''));
