...
switch ($method) {
    ...
    case 'POST':
        ...
        if($type == 'assing_test')
            order_sample_notification($user_name, '', 'access1,access3,access5', $project_name, $serial_name, $od_name, 'Order - Taiwan', $comment, $type, $items_array, $o_id, "sample");
        if($type == 'edit_test')
            order_sample_notification($user_name, 'access1', 'access5,access2,access3,access4', $project_name, $serial_name, $od_name, 'Order - Taiwan', $comment, $type, $items_array, $o_id, "sample");
