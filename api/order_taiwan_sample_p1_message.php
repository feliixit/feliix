...
switch ($method) {
    ...
    case 'POST':
        ...
        if($page == 1) {
            ...
            if($send17==true)
                order_type_notification03Access7($user_name, 'access1,access2', '', $project_name, $serial_name, $od_name, 'Order - Samples', $message, 'new_message_17', $items, $od_id, GetAccess7($od_id, $db), "sample");
        }

        if($page == 2)
            order_type_notification03($user_name, 'access1,access2,access3', '', $project_name, $serial_name, $od_name, 'Order - Samples', $message, 'new_message_19', $items, $od_id, "sample");
