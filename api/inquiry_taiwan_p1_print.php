...
if($jwt){
    ...
    try {
        ...
        $confirm_text = GetConfirmText($confirm);
        $brand = $row['brand'];
        ...
        "pid" => $pid
            ...
            $sheet->getStyle('G1:G1')->getAlignment()->setVertical('center');
            $sheet->getStyle('G2:G300')->getAlignment()->setHorizontal('left');
            $sheet->getStyle('G2:G300')->getAlignment()->setVertical('top');

            $sheet->getStyle('H1:J300')->getAlignment()->setHorizontal('center');
            $sheet->getStyle('H1:J300')->getAlignment()->setVertical('center');
            ...
            $sheet->setCellValue('B1', 'Inquiry Type');
            $sheet->setCellValue('C1', 'Brand');
            $sheet->setCellValue('D1', 'Photo 1');
            $sheet->setCellValue('E1', 'Photo 2');
            ...
            $sheet->getColumnDimension('J')->setWidth(20.82);
            ...
            foreach($merged_results as $row)
            {
                ...
                $sheet->setCellValue('I' . $i, ($row['srp'] != '' ? "₱ " . $row['srp'] : ''));
