...
$serial_name = "";
$_order = GetOrder($task_id, 'SLS', $db);
if(count($_order)>0)
...
try{
    ...
    if ($stmt->execute()) {
        ...
        // update pre items
        UpdatePreItems($task_id, $pre_items_array, 'other_task_sl', $db);
...
function SendNotifyMail01($last_id, $old_status_id, $order_type, $order_name)
{
    ...
    task_notify01_type_order($old_status, $task_status, $project_name, $task_name, $stages, $stages_status, $create_id, $assignee, $collaborator, $due_date, $detail, $last_id, $order_type, $order_name, "SLS");
...
function SendNotifyMail02($last_id, $old_status_id, $order_type, $order_name)
{
    ...
    task_notify02_type_order($old_status, $task_status, $project_name, $task_name, $stages, $stages_status, $create_id, $assignee, $collaborator, $due_date, $detail, $last_id, $order_type, $order_name, "SLS");
