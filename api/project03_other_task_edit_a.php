...
try{
    ...
    if ($stmt->execute()) {
        ...
        // update pre items
        UpdatePreItems($task_id, $pre_items_array, 'other_task_a', $db);
        ...
        if($mail_type == 2)
        {
            ...
            task_notify_admin("edit", $task_status, $title, "", $_record[0]["create_id"], $assignee, $collaborator, $due_date . " " . $due_time, $detail, $task_id, $uid, 0, $_record[0]["created_at"]);
        }
