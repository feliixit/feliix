...
switch ($method) {
    ...
    case 'POST':
        ...
        try {
            ...
            // quotation_page
            $query = "DELETE FROM approval_form_quotation_page
                      WHERE
            ...
            // quotation_page_type
            $query = "DELETE FROM approval_form_quotation_page_type
                      WHERE
                      `quotation_id` = :quotation_id";
...
{
    $sql = "SELECT id from approval_form_quotation where id = :quotation_id";
