...
try{
    ...
    if ($stmt->execute()) {
        ...
        if($mail_type == 2)
        {
            ...
            task_notify_admin_sl("edit", $task_status, $title, "", $_record[0]["create_id"], $assignee, $collaborator, $due_date . " " . $due_time, $detail, $task_id, $uid, 0, $_record[0]["created_at"]);
        }
...
function SendNotifyMail01($last_id, $old_status_id, $username)
{
    ...
    task_notify01_admin_sl($old_status, $task_status, $username, $task_name, $create_id, $assignee, $collaborator, $due_date, $detail, $last_id);
