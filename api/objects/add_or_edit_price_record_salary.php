...
class PriceRecordSalary
{
    ...
    function update()
    {
        $query = "UPDATE " . $this->table_name . "
                ...
                details = :details, pic_url = :pic_url , payee = :payee, payee_other = :payee_other, 
        ...
        $this->payee_other = htmlspecialchars(strip_tags($this->payee_other));
        ...
        $stmt->bindParam(':payee_other', $this->payee_other);
    ...
    function create()
    {
        ...
        $query = "INSERT INTO " . $this->table_name . "
                (`account`,`category`, `sub_category`, `project_name`, `related_account`, `details`, `pic_url`, `payee`, `payee_other`, `paid_date`, `cash_in`, `cash_out`, `remarks`, `staff_name`, `company_name`,`is_locked`,`is_enabled`,`is_marked`,`created_at`,`created_by`) 
                VALUES (:account,:category, :sub_category, :project_name, :related_account, :details, :pic_url, :payee, :payee_other, :paid_date, :cash_in, :cash_out, :remarks, :staff_name, :company_name, :is_locked, 1,:is_marked, now(),:created_by)";
