...
function SendNotifyMail($last_id, $uid)
{
    ...
    message_notify_dept("create", $project_name, $task_name, $stages, $create_id, $assignee, $collaborator, "", $detail, $stage_id, $msg, $username, $created_at, $_id, 'LT');
...
function GetTaskDetail($id, $db)
{
    $sql = "SELECT pt.id, title task_name, 
            ...
            potmr.created_at,
            potmr.create_id _id
            FROM project_other_task_message_reply_l potmr
            left join project_other_task_message_l pmsg on potmr.message_id = pmsg.id 
