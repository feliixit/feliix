    ...
    switch ($method) {
        ...
        case 'POST':
            ...
            try {
                ...
                $query = "delete from office_items_sub_category where status = -1 and parent_code = '$code'";
                $stmt = $db->prepare($query);
                $stmt->execute();

                // petty_list
                $query = "update office_items_sub_category
                ...
                for ($i = 0; $i < count($petty_array); $i++) {
                    ...
                    $query = "INSERT INTO office_items_sub_category
                    SET
                    `sn` = :sn,
                    `code` = :code,
                    `category` = :category,
