  ...
  try {
      ...
      switch ($method) {
          case 'GET':
            ...
            $sql = "SELECT pm.prob, pm.comment, u.username, pm.created_at FROM project_est_prob pm left join user u on u.id = pm.create_id  where project_id = " . $pid . " and pm.status <> -1 ";
