...
else
{
    try {
        ...
        // quotation_page
        $query = "UPDATE approval_form_quotation set pixa_s = :pixa_s, show_s = :show_s, pageless = :pageless, signature_page = :signature_page, signature_pixel = :signature_pixel
                WHERE
                `id` = :quotation_id";
        ...
        $stmt->bindParam(':signature_page', $page);
        $stmt->bindParam(':signature_pixel', $pixa);
...
function UpdateImageNameVariation($upload_name, $batch_id, $db){
    ...
    $query = "update approval_form_quotation_signature
