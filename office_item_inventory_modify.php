...
<head>
    ...
    div.tablebox.notes ul.head > li:nth-of-type(2) a {
    ...
    #phase1 .tablebox ul > li:nth-of-type(4) select, #phase2 .tablebox ul > li:nth-of-type(5) select {
        width: 70px;
        margin-bottom: 20px;
        margin-right: 5px;
    }
    ...
    #phase2 .tablebox ul > li.checker_result > span.green {
        color: green;
    }

    #phase2 .tablebox ul > li.checker_result > span.red {
        color: red;
    }

    #phase3 .tablebox ul > li.checker_result > span.green,
    #phase3 .tablebox ul > li.approver_result > span.green,
    #phase3 .tablebox ul > li.qty_transition > span.green {
        color: green;
    }

    #phase3 .tablebox ul > li.checker_result > span.red,
    #phase3 .tablebox ul > li.approver_result > span.red,
...
<div class="bodybox">
    ...
    <div id="app" class="mainContent">
        ...
        <div class="block A focus" style="position: relative;">
            <h6>Office Item Inventory Modification<span>{{ record.request_no }} {{ record.check_name }}</span></h6>

            <div class="box-content" id="phase1" v-if="record.status == 1">

                <div class="headings">
                    <b class="tag focus">PHASE 1</b>
                    <b class="tag">Checker Creates Item List and Encodes Modified Qty</b>
                </div>
                            ...
                            <div class="tablebox">
                                ...
                                <ul v-for="(item,index) in phase" :key="index" :class="[is_toIndex === (it_page - 1 ) * it_perPage + index ? 'shake' : '' ]" :data-attr="index">
                                    ...
                                    <li>
                                        ...
                                        <input type="number" min=1 v-model="item.qty1" placeholder="Qty">
            ...
            <div class="box-content" id="phase2" v-if="record.status == 2">
                ...
                <div class="headings">
                    ...
                    <b class="tag">Approver Reviews</b>
                </div>
            ...
            <div class="box-content" id="phase3" v-if="record.status == 3">
                ...
                <form>
                        ...
                        <li>
                            <div class="tablebox">
                                <ul class="head">
                                    ...
                                    <li>Modified Qty</li>
                                    <li>Comment</li>
                                    <li>Stock in Qty<br>After Modification</li>
                                </ul>
                    ...
                    <div class="btnbox">
                        <a class="btn" @click="go_to_modify_mgt()">Go Back To Inventory Modification Mgt.</a>
                    </div>
