...
<head>
    ...
    <!-- SEO -->
    <title>Inventory Modification Management</title>
    ...
    <style type="text/css">
        ...
        .tableframe .tablebox ul li:nth-of-type(6) {
            width: 170px;
        }
        ...
        .tableframe .tablebox ul li:nth-of-type(6) button i {
            padding: 0;
            color: #000;
        }
            ...
            <div class="block">
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <select class="selectpicker" multiple data-live-search="true" data-size="8"
                                            ...
                                            <option value=""></option>
                                            <option value="1">PHASE 1: User Chooses Reason and Creates List of Affected Item(s)</option>
                                            <option value="2">PHASE 2: Inventory Modification Completed</option>
                                        </select>
                                    </dd>
                ...
                <div class="tableframe">
                    <div class="tablebox lv1">
                        ...
                        <!-- <ul>
                            <li>IM-00001</li>
                            <li>Deliver to Client: xxxxxx</li>
...
<script src="js/inventory_modify_mgt.js"></script>
