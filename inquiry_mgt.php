            ...
            <div class="list_function">
                ...
                <div class="new_project">
                    ...
                    <div id="edit_dialog" class="dialog d-edit">
                        ...
                        <div class="formbox">
                            <dl>
                                <dt>Target Inquiry</dt>
                                <dd>
                                    <select v-model="temp_order" style="width: calc( 100% - 100px);">
                                        <option v-for="od in orders" :value="od">{{ od.serial_name }} {{ od.iq_name }}</option>
                                    </select>
                    ...
                    <div id="filter_dialog" class="dialog d-filter"><h6>Filter Function:</h6>
                        <div class="formbox">
                            <dl>
                                ...
                                <dt>Keyword (only for inquiry name, project name or inquiry no.)</dt>
            ...
            <div class="tableframe">
                <div class="tablebox lv1">
                    ...
                    <ul v-for='(receive_record, index) in displayedPosts'>
                        ...
                        <li>{{ receive_record.status == 0 ? 'Draft' : (receive_record.status == 1 ? 'Waiting Feedback from TW' : 'Inquiry Completed') }}</li>
